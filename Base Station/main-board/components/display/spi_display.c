...
void display_init(void)
{
    ...
    ESP_LOGI(TAG, "Create LVGL Buffers");
    // alloc draw buffers used by LVGL
    // it's recommended to choose the size of the draw buffer(s) to be at least 1/10 screen sized
    // static uint16_t buf1[EXAMPLE_LCD_H_RES * EXAMPLE_LCD_V_RES / 10];
    // static uint16_t buf2[EXAMPLE_LCD_H_RES * EXAMPLE_LCD_V_RES / 10];
